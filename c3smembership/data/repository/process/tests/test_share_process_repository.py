...
from c3smembership.data.repository.process.share_process_repository \
import ShareProcessRepository


class TestShareProcessRepository(unittest.TestCase):
    ...
    def test_get_member_processes(self):
        shares = ShareProcessRepository.get_member_processes('member1')
        ...
        shares = ShareProcessRepository.get_member_processes('member2')
        self.assertEqual(len(shares), 2)
        for share in shares:
            reference_codes.append(share.reference_code)
