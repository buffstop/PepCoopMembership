# -*- coding: utf-8 -*-
#
# c3sMembership documentation build configuration file, created by
...
# as the docs folder is a subfolder of the c3smembership project,
# neighboring the packages code,
#  we have to add the packages path to sys.path so autodoc can do its work
sys.path.insert(0, os.path.abspath('..'))
# as the tests are not really part of the packages code
# -- there is no __init__.py in the folders containing the tests --
# we need to add those folders to sys.path so we can use autodoc with them:
sys.path.append(os.path.abspath('../c3smembership/tests'))
sys.path.append(os.path.abspath('../c3smembership/views/tests'))
...
release = __import__('c3smembership').__version__
...
htmlhelp_basename = 'c3sMembershipdoc'
